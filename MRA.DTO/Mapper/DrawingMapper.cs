...
public class DrawingMapper : IDocumentMapper<DrawingModel, IDrawingDocument>
{
    ...
    public DrawingModel ConvertToModel(IDrawingDocument drawingDocument)
    {
        return new DrawingModel
        {
            ...
            Type = (DrawingTypes) drawingDocument.type,
            ...
            ProductType = (DrawingProductTypes) drawingDocument.product_type,
            ...
            Filter = (DrawingFilterTypes) drawingDocument.filter,
            ...
            Software = (DrawingSoftwares) drawingDocument.software,
            Paper = (DrawingPaperSizes) drawingDocument.paper,
    ...
    public IDrawingDocument ConvertToDocument(DrawingModel drawing)
    {
        return new DrawingMongoDocument
        {
            ...
            time = drawing.Time,
            name = drawing.Name ?? "",
            product_type = (int) drawing.ProductType,
            ...
            software = (int) drawing.Software,
            paper = (int) drawing.Paper,
