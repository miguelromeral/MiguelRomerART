...
public class CollectionControllerTestsDetails : CollectionControllerTestsDetailsBase
{
    [Fact]
    public async Task Details_Ok_CollectionExists()
    {
    ...
    {
        _mockAppService
            .Setup(s => s.FindCollectionByIdAsync(collectionId, true, true))
    ...
    {
        return await controller.Details(collectionId);
    }
}
